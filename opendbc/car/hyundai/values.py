...
class CAR(Platforms):
  ...
  HYUNDAI_PALISADE_HEV_LX3_HDA2 = HyundaiCanFDPlatformConfig(
    [
      HyundaiCarDocs("Hyundai Palisade Hybrid Calligraphy (with HDA II & LFA2) 2026", "Highway Driving Assist II & Lane Follow Assist 2",
